...
* Whether to use supplied values for header fields (instead of generating control numbers and timestamps for headers).
...
|useSuppliedValues="false" |Use supplied values for header fields. If true, control numbers and timestamp values present in the supplied data will be used (instead of generating these values for headers).
|===
